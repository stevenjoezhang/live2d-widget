...
const live2d_path = 'https://cdn.jsdmirror.com/gh/SDCOM-0415/live2d-widget@master/dist/';
...
(async () => {
  ...
  initWidget({
    ...
    cubism5Path: 'https://live2d.sdcom.top/sdk-web/cubismcore/live2dcubismcore.min.js', // 此处替换为自建镜像，使用腾讯云Edgeone
